    ...
    function aplicarValor() {
        ...
        if (!isNaN(val)) {
            if (root.campoActivo === "Tem") {
              ...
              else if (root.campoActivo === "Agua")   datos.agua = Math.max(30, Math.min(100, val))
    ...
    Rectangle {
        ...
        Row {
            ...
            Column {
                ...
                Rectangle {
                    width: parent.width; height: parent.height * 0.13; radius: height/2
                    color: root.campoActivo === "Agua" ? "#A5D6A7" : "#8DBB5A"
                    ...
                    Text { anchors.left: parent.left; anchors.leftMargin: parent.width * 0.45; anchors.verticalCenter: parent.verticalCenter; text: root.campoActivo === "Agua" ? root.entradaTemporal + "|" : datos.agua; font.pixelSize: parent.height * 0.40; font.bold: true; color: "black" }
                    MouseArea { anchors.fill: parent; onClicked: { root.campoActivo = "Agua"; root.entradaTemporal = ""; root.forceActiveFocus() } }
                }
                Rectangle {
                    width: parent.width; height: parent.height * 0.13; radius: height/2
